...
import flexjob.protos.google.api.launch_stage_pb2
...
class CommonLanguageSettings(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        reference_docs_uri: builtins.str = ...,
        destinations: collections.abc.Iterable[
            global___ClientLibraryDestination.ValueType
        ]
        | None = ...,
    ) -> None: ...
...
class ClientLibrarySettings(google.protobuf.message.Message):
    ...
    """
    launch_stage: flexjob.protos.google.api.launch_stage_pb2.LaunchStage.ValueType
...
class Publishing(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        doc_tag_prefix: builtins.str = ...,
        organization: global___ClientLibraryOrganization.ValueType = ...,
        library_settings: collections.abc.Iterable[global___ClientLibrarySettings]
        | None = ...,
        proto_reference_documentation_uri: builtins.str = ...,
    ) -> None: ...
    def ClearField(
...
class JavaSettings(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        library_package: builtins.str = ...,
        service_class_names: collections.abc.Mapping[builtins.str, builtins.str]
        | None = ...,
...
class DotnetSettings(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        common: global___CommonLanguageSettings | None = ...,
        renamed_services: collections.abc.Mapping[builtins.str, builtins.str]
        | None = ...,
        renamed_resources: collections.abc.Mapping[builtins.str, builtins.str]
        | None = ...,
...
class MethodSettings(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "long_running", b"long_running", "selector", b"selector"
        ],
    ) -> None: ...
